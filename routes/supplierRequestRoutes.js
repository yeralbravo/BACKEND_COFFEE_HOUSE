    ...
    findRequestByPhone, 
    findRequestByNit 
    } from '../models/SupplierRequest.js';
    ...
    // 📌 Validación en tiempo real (correo, teléfono, nit)
    ...
    try {
        ...
        // Crea usuario supplier con contraseña temporal
        ...
        const emailContent = `
            ...
            <p>Te recomendamos cambiar tu contraseña por una más segura después de tu primer inicio de sesión.</p>
        `;
